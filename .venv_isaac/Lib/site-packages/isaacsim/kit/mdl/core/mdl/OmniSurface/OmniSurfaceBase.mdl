...
export material OmniSurfaceBase(
    ...
    uniform bool round_edges_across_materials = false [[
        ...
        anno::description("Normal smoothing happens only between facets of equal material, unless
                           this parameter is set true, in which case the smoothing happens between
                           facets irrespective of their materials"),
        anno::in_group("Geometry")
    ]],
    ...
    float2 geometry_normal_roughness = float2(0.0) [[
        anno::display_name("Geometry Normal Roughness"),
        anno::in_group("Geometry")
    ]],
...
[[
    ...
    anno::in_group("Omni Materials", "OmniSurface"),
    anno::author("NVIDIA Corporation"),
    anno::key_words(string[]("generic", "surface")),
    anno::thumbnail(".thumbs/OmniSurfaceBase.png"),
    anno::version(1, 0, 0, "")
]] = let {
    ...
    float specular_reflection_roughness_u =
        specular_reflection_roughness_anisotropy.x +
        geometry_normal_roughness.x * geometry_normal_roughness.x * geometry_normal_roughness_strength;

    float specular_reflection_roughness_v =
        specular_reflection_roughness_anisotropy.y +
        geometry_normal_roughness.y * geometry_normal_roughness.y * geometry_normal_roughness_strength;
    ...
    color specular_retro_reflection_multiscatter_tint = color(1.0);
