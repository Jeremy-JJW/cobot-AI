...
[[
 ...
 = let{
	...
	// TODO: Clearcoat's induced roughness from normal map should also apply here, but right now avoiding it due to confusing relationship in the normals
	bsdf ggx_smith_bsdf = df::microfacet_ggx_smith_bsdf(
		roughness_u:reflection_roughness_1 * reflection_roughness_1 + (geometry_normal_roughness_strength * normal_data.roughness.x * normal_data.roughness.x),
		roughness_v:reflection_roughness_1 * reflection_roughness_1 + (geometry_normal_roughness_strength * normal_data.roughness.y * normal_data.roughness.y),
	...
	bsdf clearcoat_bsdf = df::microfacet_ggx_smith_bsdf(
		roughness_u: clearcoat_reflection_roughness * clearcoat_reflection_roughness + (geometry_normal_roughness_strength * clearcoat_normal_data.roughness.x * clearcoat_normal_data.roughness.x),
		roughness_v: clearcoat_reflection_roughness * clearcoat_reflection_roughness + (geometry_normal_roughness_strength * clearcoat_normal_data.roughness.y * clearcoat_normal_data.roughness.y),
		tint:        color(1.0f),
		mode:        df::scatter_reflect
	);
