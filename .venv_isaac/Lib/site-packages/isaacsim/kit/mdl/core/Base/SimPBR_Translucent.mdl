...
[[
    anno::display_name("Sim PBR Translucent"),
    anno::description("Supports the translucent material model of the Sim Renderer"),
    anno::in_group("SimReady"),
    anno::version( 1, 0, 0),
    anno::author("NVIDIA CORPORATION"),
    anno::key_words(string[]("Sim", "PBR", "translucent", "omniverse", "generic"))
]]
 = let {
