...
[[
    ...
    anno::display_name("Bitmap"),
    anno::description("3DS-MDL Bitmap")
]]
{
...
[[
    ...
    anno::description("3DS-MDL Bitmap for bump")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Bitmap Normal"),
    anno::description("3DS-MDL Bitmap Normal")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Color Correction"),
    anno::description("3DS-MDL Color Correction")
]]
{
    // channel rewiring
...
export float3
[[ anno::node_output_port_default(anno::node_port_value_and_fields)]]
ad_3dsmax_color_correction_bump(
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Color Correction Bump"),
    anno::description("3DS-MDL Color Correction for bump")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Composite"),
    anno::description("3DS-MDL Composite")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Composite Bump"),
    anno::description("3DS-MDL Composite for bump")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Dent Bump"),
    anno::description("3DS-MDL Dent for bump")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Gradient Ramp"),
    anno::description("3DS-MDL Gradient Ramp")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Gradient Ramp Bump"),
    anno::description("3DS-MDL Gradient Ramp for bump")
]]
{
   float3 perlin_normal = base::perlin_noise_bump_texture
   (
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Falloff"),
    anno::description("3DS-MDL Falloff")
]]
{
    return color1;
}
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Mix"),
    anno::description("3DS-MDL Mix")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Mix Bump"),
    anno::description("3DS-MDL Mix for bump")
]]
{
    float t = useCurve ? math::smoothstep(lower, upper, mixAmount) : math::smoothstep(0.0, 1.0, mixAmount);
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Noise"),
    anno::description("3DS-MDL Noise")
]]
{
   return base::perlin_noise_texture
   (
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Noise Bump"),
    anno::description("3DS-MDL Noise for bump")
]]
{
   float3 perlin_normal = base::perlin_noise_bump_texture
   (
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Output"),
    anno::description("3DS-MDL Output")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Output Bump"),
    anno::description("3DS-MDL Output for bump")
]]
{
    float3 normal = MAP1;
    if(invert)
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Tiles"),
    anno::description("3DS-MDL Tiles")
]]
{
...
[[
    anno::author("NVIDIA Corporation"),
    anno::display_name("Tiles Bump"),
    anno::description("3DS-MDL Tiles for bump")
]]
{
    float3 uvw = state::texture_coordinate(0);
    float2 uv(0.f, 0.f);
