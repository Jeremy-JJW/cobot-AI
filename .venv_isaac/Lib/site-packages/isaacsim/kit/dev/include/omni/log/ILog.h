...
#ifndef OMNI_LOG_REQUIRE_CHANNEL
//! If `1`, the OMNI_LOG family of macros will require a channel to be specified. Otherwise, a channel is optional.
//! If not defined by project settings, the value is `0`.
#    define OMNI_LOG_REQUIRE_CHANNEL 0
#endif
...
#    if OMNI_LOG_REQUIRE_CHANNEL
#        define OMNI_LOG_CHECK_CHANNEL(channelOrFormat_)                                                               \
            static_assert(                                                                                             \
                std::is_convertible_v<decltype(channelOrFormat_), const ::carb::logging::detail::LogChannelData&>,     \
                "Specifying a channel is required due to OMNI_LOG_REQUIRE_CHANNEL=1")
#    else
#        define OMNI_LOG_CHECK_CHANNEL(channelOrFormat_) static_cast<void>(0)
#    endif
...
#    define OMNI_LOG_WRITE_EX(channelOrFormat_, level_, file_, func_, line_, ...)                                      \
        ...
        {                                                                                                              \
            ...
            OMNI_LOG_CHECK_CHANNEL(channelOrFormat_);                                                                  \
            if (omni::log::detail::isChannelEnabled(level_, channelOrFormat_))                                         \
            {                                                                                                          \
                omni::log::ILog* log_ = omniGetLogWithoutAcquire();                                                    \
                if (log_)                                                                                              \
                {                                                                                                      \
                    omni::log::detail::writeLog(channelOrFormat_, log_, level_, file_, func_, line_, ##__VA_ARGS__);   \
                }                                                                                                      \
            }                                                                                                          \
        } while (0)
#endif
...
class OMNI_ATTR("no_gil") ILogMessageConsumer_abi
...
protected:
    ...
    //! object in parallel.
    virtual OMNI_ATTR("no_gil") void onMessage_abi(OMNI_ATTR("c_str, not_null") const char* channel,
                                                   Level level,
...
protected:
    ...
    virtual OMNI_ATTR("no_gil") void onChannelUpdate_abi(OMNI_ATTR("not_null") ILog* log,
...
class OMNI_ATTR("no_gil") ILog_abi : public omni::core::Inherits<omni::core::IObject, OMNI_TYPE_ID("omni.log.ILog")>
{
protected:
    ...
    virtual OMNI_ATTR("consumer=onMessage_abi, no_gil") void addMessageConsumer_abi(
        OMNI_ATTR("not_null") ILogMessageConsumer* consumer) noexcept = 0;
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") void removeMessageConsumer_abi(ILogMessageConsumer* consumer) noexcept = 0;
    ...
    virtual OMNI_ATTR("py_not_prop, no_gil") bool setAsync_abi(bool logAsync) noexcept = 0;

    //! Returns `true` if asynchronous logging is enabled.
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("py_not_prop, no_gil") bool isAsync_abi() noexcept = 0;
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") void setChannelLevel_abi(OMNI_ATTR("c_str, not_null") const char* name,
                                                         Level level,
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") omni::core::Result
        getChannelLevel_abi(OMNI_ATTR("c_str, not_null") const char* name,
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") void setChannelEnabled_abi(OMNI_ATTR("c_str, not_null") const char* name,
                                                           bool isEnabled,
                                                           SettingBehavior behavior) noexcept = 0;
    ...
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") omni::core::Result
        getChannelEnabled_abi(OMNI_ATTR("c_str, not_null") const char* name,
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") void setChannelDescription_abi(OMNI_ATTR("c_str, not_null") const char* name,
                                                               OMNI_ATTR("c_str, not_null")
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") bool isLoggingAtLevel_abi(OMNI_ATTR("c_str, not_null") const char* name,
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual void OMNI_ATTR("consumer=onChannelUpdate_abi, no_gil")
    ...
    //!
    //! @thread_safety This method is thread safe.
    virtual OMNI_ATTR("no_gil") void removeChannelUpdateConsumer_abi(ILogChannelUpdateConsumer* consumer) noexcept = 0;
...
public:
    ...
    //! @copydoc omni::log::ILog_abi::setChannelEnabled_abi
    void setChannelEnabled(const ::carb::logging::detail::DefaultLogChannelData&,
                           bool isEnabled,
                           omni::log::SettingBehavior behavior) noexcept
    {
        setChannelEnabled(OMNI_LOG_DEFAULT_CHANNEL.name, isEnabled, behavior);
    }
    ...
    //! @copydoc omni::log::ILog_abi::getChannelEnabled_abi
    omni::core::Result getChannelEnabled(const ::carb::logging::detail::DefaultLogChannelData&,
                                         bool* outEnabled,
                                         omni::log::SettingBehavior* outBehavior) noexcept
    {
        return getChannelEnabled(OMNI_LOG_DEFAULT_CHANNEL.name, outEnabled, outBehavior);
    }
    ...
    //! @copydoc omni::log::ILog_abi::setChannelLevel_abi
    void setChannelLevel(const ::carb::logging::detail::DefaultLogChannelData&,
                         omni::log::Level level,
                         omni::log::SettingBehavior behavior) noexcept
    {
        setChannelLevel(OMNI_LOG_DEFAULT_CHANNEL.name, level, behavior);
    }
    ...
    //! @copydoc omni::log::ILog_abi::getChannelLevel_abi
    omni::core::Result getChannelLevel(const ::carb::logging::detail::DefaultLogChannelData&,
                                       omni::log::Level* outLevel,
                                       omni::log::SettingBehavior* outBehavior) noexcept
    {
        return getChannelLevel(OMNI_LOG_DEFAULT_CHANNEL.name, outLevel, outBehavior);
    }
    ...
    //! @copydoc omni::log::ILog_abi::isLoggingAtLevel_abi
    bool isLoggingAtLevel(const ::carb::logging::detail::DefaultLogChannelData&, omni::log::Level level)
    {
        return isLoggingAtLevel(OMNI_LOG_DEFAULT_CHANNEL.name, level);
    }
...
#    else
#        define OMNI_LOG_VALIDATE_FORMAT(...) static_cast<void>(0)
#    endif
...
// Implementation detail. Checks the message's level against the channel's level and logs as appropriate.
template <class... ArgList>
void writeLog(const ::carb::logging::detail::DefaultLogChannelData&,
              ILog* log,
              Level level,
              const char* filename,
              const char* function,
              ...
              ArgList&&... args)
{
    log->logf(OMNI_LOG_DEFAULT_CHANNEL.name, level, omniGetModuleFilename(), filename, function, uint32_t(line), fmt,
              std::forward<ArgList>(args)...);
}
...
template <class... ArgList>
void writeLog(
    const char* fmt, ILog* log, Level level, const char* filename, const char* function, int32_t line, ArgList&&... args)
{
    log->logf(OMNI_LOG_DEFAULT_CHANNEL.name, level, omniGetModuleFilename(), filename, function, (uint32_t)line, fmt,
              std::forward<ArgList>(args)...);
}
...
inline bool isChannelEnabled(Level level, const LogChannelData& channel)
{
    return (static_cast<Level>(channel.level) <= level);
}

// Implementation detail. Checks the message's level against the channel's level.
inline bool isChannelEnabled(Level level, const ::carb::logging::detail::DefaultLogChannelData&)
{
    return static_cast<Level>(OMNI_LOG_DEFAULT_CHANNEL.level) <= level;
}

// Implementation detail. Checks the message's level against the default channel
inline bool isChannelEnabled(Level level, const char* /*fmt*/)
{
    return (static_cast<Level>(OMNI_LOG_DEFAULT_CHANNEL.level) <= level);
}
...
inline std::vector<omni::core::ObjectPtr<omni::log::ILogMessageConsumer>> omni::log::ILog::getMessageConsumers() noexcept
{
    ...
    {
        OMNI_LOG_ERROR(OMNI_LOG_DEFAULT_CHANNEL, "unable to retrieve log channel settings consumers: 0x%08X", result);
    }
...
inline std::vector<omni::core::ObjectPtr<omni::str::IReadOnlyCString>> omni::log::ILog::getChannelNames() noexcept
{
    ...
    if (OMNI_FAILED(result))
    {
        OMNI_LOG_ERROR(OMNI_LOG_DEFAULT_CHANNEL, "unable to retrieve log channel names: 0x%08X", result);
    }
...
inline std::vector<omni::core::ObjectPtr<omni::log::ILogChannelUpdateConsumer>> omni::log::ILog::getChannelUpdateConsumers() noexcept
{
    ...
    if (OMNI_FAILED(result))
    {
        OMNI_LOG_ERROR(OMNI_LOG_DEFAULT_CHANNEL, "unable to retrieve log channel updated consumers: 0x%08X", result);
    }
