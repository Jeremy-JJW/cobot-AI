...
constexpr void null_check(const char* ptr, carb::cpp::string_view function)
{
    if (ptr == nullptr)
    {
        CARBLOCAL_THROW(std::invalid_argument, carb::extras::join(function, " invalid nullptr argument").c_str());
    }
}
} // namespace detail
...
inline string::string(const value_type* s)
{
    ...
    size_type new_size = length_check(0, s ? traits_type::length(s) : 0, "string::string");
...
inline string::string(carb::cpp::string_view sv)
{
    set_empty();
    initialize(sv.data(), sv.size());
}

inline string::string(carb::cpp::string_view sv, size_type pos, size_type n)
{
...
inline string& string::operator=(carb::cpp::string_view sv)
{
...
inline string& string::assign(const string& str, size_type pos, size_type n)
{
    ...
    return assign(str.data() + pos, new_size);
}
...
inline string& string::assign(const value_type* s, size_type n)
{
    ...
    n = length_check(0, n, "string::assign");

    if (n > capacity())
    {
        // grow_buffer_and_fill handles overlaps correctly by copying before destroying
        grow_buffer_and_fill(n, s, n, nullptr, 0, nullptr, 0);
    }
    else
    {
        std::memmove(get_pointer(0), s, n);
        set_size(n);
    }
...
{
    return assign(s, s ? traits_type::length(s) : 0);
}
...
inline string& string::assign(carb::cpp::string_view sv)
{
    return assign(sv.data(), sv.size());
}

inline string& string::assign(carb::cpp::string_view sv, size_type pos, size_type n)
{
    range_check(pos, sv.size(), "string::assign");

    size_type new_size = ::carb_min(n, sv.size() - pos);

    return assign(sv.data() + pos, new_size);
}
...
constexpr string::operator carb::cpp::zstring_view() const noexcept
{
    return carb::cpp::zstring_view(data(), size());
}
...
{
    return insert_internal(pos, s, s ? traits_type::length(s) : 0);
}
...
inline string& string::insert(size_type pos, carb::cpp::string_view sv)
{
    return insert_internal(pos, sv.data(), sv.size());
}

inline string& string::insert(size_type pos1, carb::cpp::string_view sv, size_type pos2, size_type n)
{
...
{
    return append_internal(s, s ? traits_type::length(s) : 0);
}
...
inline string& string::append(carb::cpp::string_view sv)
{
    return append_internal(sv.data(), sv.size());
}

inline string& string::append(carb::cpp::string_view sv, size_type pos, size_type n)
{
...
{
    return compare_internal(get_pointer(0), s, size(), s ? traits_type::length(s) : 0);
}
...
constexpr int string::compare(size_type pos1, size_type n1, const value_type* s) const
{
    ...
    size_type this_size = ::carb_min(n1, size() - pos1);
    return compare_internal(get_pointer(pos1), s, this_size, s ? traits_type::length(s) : 0);
}
...
constexpr int string::compare(size_type pos1, size_type n1, const value_type* s, size_type n2) const
{
    ...
    size_type this_size = ::carb_min(n1, size() - pos1);
    return compare_internal(get_pointer(pos1), s, this_size, s ? n2 : 0);
}
...
constexpr int string::compare(carb::cpp::string_view sv) const noexcept
{
    return compare_internal(get_pointer(0), sv.data(), size(), sv.size());
}

constexpr int string::compare(size_type pos1, size_type n1, carb::cpp::string_view sv) const
{
    range_check(pos1, size(), "string::compare");
...
constexpr int string::compare(size_type pos1, size_type n1, carb::cpp::string_view sv, size_type pos2, size_type n2) const
{
    range_check(pos1, size(), "string::compare");
...
{
    size_type length = s ? traits_type::length(s) : 0;
...
template <typename T, typename>
constexpr bool string::starts_with(const T& t) const noexcept
{
    std::string_view sv = t;
    if (size() >= sv.size())
    {
...
template <typename T, typename>
constexpr bool string::ends_with(const T& t) const noexcept
{
    std::string_view sv = t;
    if (size() >= sv.size())
    {
...
template <typename T, typename>
constexpr bool string::contains(const T& t) const noexcept
{
    std::string_view sv = t;
...
string& string::replace(const_iterator i1, const_iterator i2, InputIterator j1, InputIterator j2)
{
    ...
    return replace_internal(
        i1, i2, j1, j2,
        std::disjunction<std::is_same<InputIterator, iterator>, std::is_same<InputIterator, const_iterator>>{});
}
...
{
    return replace(pos, n1, s, s ? traits_type::length(s) : 0);
}
...
inline string& string::replace(size_type pos1, size_type n1, carb::cpp::string_view sv)
{
    return replace(pos1, n1, sv.data(), sv.size());
}

inline string& string::replace(size_type pos1, size_type n1, carb::cpp::string_view sv, size_type pos2, size_type n2)
{
...
{
    range_check(i1, i2, "string::replace");
    size_type replacement_size = s ? traits_type::length(s) : 0;
    size_type pos = (size_type)std::distance(cbegin(), i1);
    size_type n1 = (size_type)std::distance(i1, i2);
...
inline string& string::replace(const_iterator i1, const_iterator i2, carb::cpp::string_view sv)
{
    range_check(i1, i2, "string::replace");
    size_type pos = (size_type)std::distance(cbegin(), i1);
    size_type n1 = (size_type)std::distance(i1, i2);
...
CARB_CPP20_CONSTEXPR inline string::size_type string::copy(value_type* s, size_type n, size_type pos) const
{
...
{
    return find(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::find(carb::cpp::string_view sv, size_type pos) const noexcept
{
    return find(sv.data(), pos, sv.size());
}
...
{
    return rfind(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::rfind(carb::cpp::string_view sv, size_type pos) const noexcept
{
...
{
    return find_first_of(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::find_first_of(carb::cpp::string_view sv, size_type pos) const noexcept
{
...
{
    return find_last_of(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::find_last_of(carb::cpp::string_view sv, size_type pos) const noexcept
{
...
constexpr string::size_type string::find_first_not_of(const value_type* s, size_type pos) const
{
    ...
    return find_first_not_of(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::find_first_not_of(carb::cpp::string_view sv, size_type pos) const noexcept
{
...
{
    return find_last_not_of(s, pos, s ? traits_type::length(s) : 0);
}
...
constexpr string::size_type string::find_last_not_of(carb::cpp::string_view sv, size_type pos) const noexcept
{
...
constexpr void string::range_check(size_type pos, size_type size, const char* function) const
{
    if (CARB_UNLIKELY(pos > size))
    {
        CARBLOCAL_THROW(std::out_of_range,
                        carb::extras::join(carb::cpp::unsafe_length, function, ": Provided pos ", std::to_string(pos),
...
inline void string::initialize(const_pointer src, size_type size)
{
    if (size != 0)
    {
        ::omni::detail::null_check(src, "string::initialize");
    }
...
inline string& string::append_internal(const_pointer src, size_type n)
{
    if (n != 0)
    {
        ::omni::detail::null_check(src, "string::append");
    }
    size_type new_size = length_check(size(), n, "string::append");
...
{
    size_type compare_size = ::carb_min(this_str ? this_size : 0, other_str ? other_size : 0);
...
{
    string::size_type rhs_len = rhs ? string::traits_type::length(rhs) : 0;
...
{
    string::size_type lhs_len = lhs ? string::traits_type::length(lhs) : 0;
