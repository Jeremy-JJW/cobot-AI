...
//! @param name_ The globally-unique name of the plugin. Must be unique with respect to all other plugins. May not be
//!   empty.
//! @param desc_ (Literal string) Description of the plugin.
...
//! name of the default log channel. Must not be empty.
