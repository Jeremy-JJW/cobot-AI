...
private:
    ...
    static constexpr char kLaunchLockExtension[] = ".lock";

    /** Extension of the name for the exit guard locks. */
    static constexpr char kExitLockExtension[] = ".exit";

    /** Default prefix for the lock guards. */
    static constexpr char kDefaultNamePrefix[] = "nvidia-unique-app";
...
#    endif
     ...
     *           test.
     */
    std::string _getGuardName(carb::cpp::string_view extension) const
    {
        return carb::extras::join(m_guardPath, "/", m_guardName, extension);
    }
