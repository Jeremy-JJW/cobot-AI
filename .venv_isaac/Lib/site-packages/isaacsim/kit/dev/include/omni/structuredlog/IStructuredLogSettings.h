...
public:
    ...
    bool loadPrivacySettingsFromFile(const char* filename, PrivacyLoadFlags flags)
    {
        ...
        //       this is parsed.
        static constexpr char kPrivacyFileSetting[] = "/structuredLog/privacySettingsFile";
        ...
        settings::detail::set(settings, kPrivacyFileSetting, cpp::string_view(cpp::unsafe_length, filename));
        bool success = loadPrivacySettings_abi();
