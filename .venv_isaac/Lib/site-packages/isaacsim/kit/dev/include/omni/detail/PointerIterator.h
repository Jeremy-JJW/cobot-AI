...
template <typename TPointer, typename TContainer>
constexpr PointerIterator<TPointer, TContainer> operator+(typename PointerIterator<TPointer, TContainer>::difference_type dist,
...
constexpr auto operator-(const PointerIterator<TPointer, TContainer>& lhs,
...
template <typename TPointer, typename UPointer, typename TContainer>
constexpr bool operator==(const PointerIterator<TPointer, TContainer>& lhs,
                          const PointerIterator<UPointer, TContainer>& rhs) noexcept
{
    return lhs.operator->() == rhs.operator->();
}
