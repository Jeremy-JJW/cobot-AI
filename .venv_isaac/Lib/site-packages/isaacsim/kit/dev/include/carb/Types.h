...
{
    const char* name; //!< Name of the plugin (e.g. "carb.dictionary.plugin"). Must be globally unique and not empty.
...
//! Either this or OnPluginRegisterExFn or OnPluginRegisterFn are required.  Populates the given
 ...
 * Timeout constant
 */
constexpr uint32_t kTimeoutInfinite = UINT32_MAX;
...
//! A handle type for \ref Framework::addRegisterHook() and \ref Framework::removeRegisterHook()
