...
{
    /** flags to indicate some additional behavior of the context.  This may be a set of zero or
     *  more of the @ref PlaybackContextFlags flags.
     */
...
struct ContextCaps
{
     ...
     *  returned by getDeviceCaps() as this is the format that the audio is
