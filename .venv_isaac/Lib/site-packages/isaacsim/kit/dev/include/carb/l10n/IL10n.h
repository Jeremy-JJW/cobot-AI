 ...
 *  @returns nullptr.
 */
inline const char* CARB_ABI getLocalizedStringFromHashNoPlugin([[maybe_unused]] const LanguageTable* table,
                                                               [[maybe_unused]] StringIdentifier id,
                                                               [[maybe_unused]] const LanguageIdentifier* language) noexcept
{
    CARB_LOG_ERROR(CARB_LOG_DEFAULT_CHANNEL, "localization is being used with carb.l10n.plugin not loaded");
    return nullptr;
}
