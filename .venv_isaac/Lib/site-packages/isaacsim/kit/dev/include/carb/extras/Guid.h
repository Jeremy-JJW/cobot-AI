...
inline bool stringToGuid(const std::string& src, Guid* guid)
{
    if (src[0] == '{')
    {
        return sscanf(src.c_str(), "{%8x-%4hx-%4hx-%2hhx%2hhx-%2hhx%2hhx%2hhx%2hhx%2hhx%2hhx}", &guid->data1,
    ...
    return sscanf(src.c_str(), "%8x-%4hx-%4hx-%2hhx%2hhx-%2hhx%2hhx%2hhx%2hhx%2hhx%2hhx", &guid->data1, &guid->data2,
