...
public:
     ...
     *
     * @param str carb::cpp::string_view object
     * @return A copy of the string held on the arena
     */
    const char* allocateString(cpp::string_view str);
...
private:
    ...
    Block* _newCurrentBlock(size_t size, size_t alignment)
    {
        ...
        // Allocate the memory
        uint8_t* alloc = (uint8_t*)std::malloc(allocSize);
        if (!alloc)
        {
...
inline const char* ArenaAllocator::allocateString(cpp::string_view str)
{
