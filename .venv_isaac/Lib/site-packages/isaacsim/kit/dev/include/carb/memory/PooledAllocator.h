...
public:
    ...
    {
        CARB_RELEASE_ASSERT(n <= 1, "PooledAllocator::allocate does not support n > 1");
    ...
    {
        CARB_RELEASE_ASSERT(n <= 1, "PooledAllocator::deallocate does not support n > 1");
