...
<AutoVisualizer xmlns="http://schemas.microsoft.com/vstudio/debugger/natvis/2010">
    ...
    <Type Name="carb::tasking::Mutex">
        ...
        <Intrinsic Name="threadFlag" Expression="uint64_t(1) &lt;&lt; 63" /> <!-- kThreadFlag -->
        <DisplayString Condition="!owner()">{{ Mutex {{ unlocked }} }}</DisplayString>
        <DisplayString Condition="owner() &amp; threadFlag()">{{ Mutex {{ locked by thread {owner() &amp; ~threadFlag()} }} }}</DisplayString>
        <DisplayString>{{ Mutex {{ locked by fiber {(void*)owner()} }} }}</DisplayString>
        <Expand>
            <Item Name="[recursive]">p()->m_recursive</Item>
            <Item Name="[owner thread]" Condition="owner() &amp;&amp; !!(owner() &amp; threadFlag())">owner() &amp; ~threadFlag()</Item>
            <Item Name="[owner fiber]" Condition="owner() &amp;&amp; !(owner() &amp; threadFlag())">(carb::tasking::Fiber*)owner()</Item>
    ...
    <Type Name="carb::tasking::ThreadLocalStorage">
        <DisplayString>{{ thread {*(uint32_t*)&amp;threadId} }}</DisplayString>
    </Type>
    
    <Type Name="carb::tasking::Scheduler">
        <Intrinsic Name="threadList" Expression="*(PaddedThreadLocalStorage**)&amp;m_tlsData" />
        <Intrinsic Name="threadTls" Expression="(carb::tasking::ThreadLocalStorage*)(threadList() + Index)">
        ...
        <Expand>
            ...
            <Synthetic Name="[threads]">
                <DisplayString>{{ {m_threadCount} }}</DisplayString>
                <Expand>
                    <Item Name="[count]">m_threadCount</Item>
                    <ArrayItems>
                        <Size>m_threadCount</Size>
                        <ValuePointer>threadList()</ValuePointer>
                    </ArrayItems>
                </Expand>
            </Synthetic>
            ...
            <Item Name="[current thread's task]" Optional="true">m_tls</Item>
            <Item Name="[task counts by function]" Condition="!m_recordTaskCounts">"Requires /recordTaskCounts",sb</Item>
            <Item Name="[task counts by function]" Condition="m_recordTaskCounts">m_taskCounts</Item>
            <Item Name="[task database]">m_taskHandleDb</Item>
            <Synthetic Name="[fiber database]">
                <DisplayString>{{ FiberDatabase }}</DisplayString>
                <Expand>
                    <CustomListItems MaxItemsPerView="100">
                        <Variable Name="thread" InitialValue="0" />
                        <Variable Name="head" InitialValue="(FiberSlab*)nullptr" />
                        <Variable Name="fiber" InitialValue="(Fiber*)nullptr" />
                        <Variable Name="index" InitialValue="(size_t)0" />

                        <Loop Condition="thread &lt;= m_threadCount">
                            <Exec>head = (thread == m_threadCount) ? m_fiberDb.m_externalHead : threadTls(thread)-&gt;slabHead</Exec>

                            <Loop Condition="head">
                                <Exec>index = 0</Exec>
                                <If Condition="head-&gt;freeCount != kFibersPerSlab">
                                    <Loop Condition="index != kFibersPerSlab">
                                        <Exec>fiber = head-&gt;fibers + index</Exec>
                                        <If Condition="(fiber->flags() &amp; FiberFlags::eStateMask) != FiberFlags::eCreated" >
                                            <Item>fiber</Item>
                                        </If>
                                        <Exec>index++</Exec>
                                    </Loop>
                                </If>
                                <Exec>head = head-&gt;pnext</Exec>
                            </Loop>
                            <Exec>++thread</Exec>
                        </Loop>
                    </CustomListItems>
                    <Item Name="[Raw View]">m_fiberDb</Item>
                </Expand>
            </Synthetic>
        </Expand>
    </Type>
    <Type Name="carb::tasking::PriorityTaskQueue&lt;*,*&gt;">
        <Expand>
            <ArrayItems>
                <Size>kNumLanes</Size>
                <ValuePointer>m_lanes</ValuePointer>
            </ArrayItems>
        </Expand>
    </Type>
    ...
    <Type Name="carb::tasking::TaskBundle">
        ...
        <DisplayString Condition="flags() &amp; eFlagCanceled">[canceled] {name(),s} {task}</DisplayString>
        <DisplayString Condition="flags() &amp; eFlagFinished">[finished] {name(),s} {task}</DisplayString>
        ...
        <Expand>
            ...
            <Item Name="[state]" Condition="flags() &amp; eFlagTaskWaiting">"[waiting]",sb</Item>
            <Item Name="[state]" Condition="flags() &amp; eFlagCanceled">"[canceled]",sb</Item>
            <Item Name="[state]" Condition="(flags() &amp; (eFlagCanceled|eFlagFinished)) == eFlagFinished">"[finished]",sb</Item>
            <Item Name="[state]" Condition="(flags() &amp; (eFlagTaskWaiting|eFlagFinished|eFlagStarted)) == eFlagStarted">"[running]",sb</Item>
            <Item Name="[state]" Condition="(flags() &amp; (eFlagStarted|eFlagPrereqsMet)) == eFlagPrereqsMet">"[new]",sb</Item>
            <Item Name="[state]" Condition="!(flags() &amp; eFlagPrereqsMet)">"[pending]",sb</Item>
            ...
            <Synthetic Name="[flags]">
                ...
                <Expand>
                    ...
                    <Item Name="[reserved]" Condition="flags() &amp; 0x00fffff8">(flags() &amp; 0x00fffff8),x</Item>
                    <Item Name="eFlagCanceled">!!(flags() &amp; eFlagCanceled) ? 1 : 0</Item>
                    <Item Name="eFlagStolen">!!(flags() &amp; eFlagStolen) ? 1 : 0</Item>
                    <Item Name="eFlagFiberless">!!(flags() &amp; eFlagFiberless) ? 1 : 0</Item>
    ...
    <Type Name="carb::tasking::Fiber">
        <Intrinsic Name="flags" Expression="*(uint32_t*)&amp;m_flags" />
        <Intrinsic Name="state" Expression="(carb::tasking::FiberFlags)(flags() &amp; eStateMask)" />
        <DisplayString>{{ fiber {(void*)this} - {state()} }}</DisplayString>
        <Expand>
            <Synthetic Name="[flags]">
                <DisplayString>{flags(),x}</DisplayString>
                <Expand>
                    <Item Name="[state]">state()</Item>
                    <Item Name="[reserved]" Condition="flags() &amp; 0x01fffff8">(flags() &amp; 0x01fffff8),x</Item>
    ...
    <Type Name="carb::tasking::ThreadFiber">
        <Intrinsic Name="flags" Expression="*(uint32_t*)&amp;m_flags" />
        <Expand>
            <Synthetic Name="[flags]">
                <DisplayString>{flags(),x}</DisplayString>
            ...
            <Item Name="[task]">*(carb::tasking::TaskBundle*)m_context</Item>
            <Item Name="[fls slots]">m_flsSlots</Item>
            <Synthetic Optional="true" Name="[waiting callstack]" Condition="!!m_callstackSize">
                <DisplayString>{{ size = {m_callstackSize} }}</DisplayString>
                <Expand>
                    <ArrayItems>
                        <Size>m_callstackSize</Size>
                        <ValuePointer>m_callstack</ValuePointer>
                    </ArrayItems>
                </Expand>
            </Synthetic>
        </Expand>
    ...
    <Type Name="carb::tasking::FinishTracking">
        ...
        <Expand>
            <ArrayItems>
                <Size>m_count</Size>
                <ValuePointer>m_entries</ValuePointer>
            </ArrayItems>
        </Expand>
    </Type>
    ...
    <Type Name="carb::cpp::counting_semaphore&lt;*&gt;">
    ...
    <Type Name="carb::cpp::span&lt;*,0&gt;" Priority="High">
        <DisplayString>{{ size=0 }}</DisplayString>
    </Type>

    <Type Name="carb::cpp::span&lt;*,-1&gt;" Priority="High">
        <DisplayString>{{ size={m_size} }}</DisplayString>
        <Expand>
            <ArrayItems>
                <Size>m_size</Size>
    ...
    <Type Name="carb::tasking::ThreadLocalHandleDatabase&lt;*,*&gt;">
        <Intrinsic Name="at" Expression="*(SlabArray**)&amp;m_slabs[Index]">
            <Parameter Name="Index" Type="size_t"/>
        </Intrinsic>
        <Intrinsic Name="meta" Expression="*(uint64_t*)&amp;HData->metadata">
            <Parameter Name="HData" Type="HandleData*"/>
        ...
        <Intrinsic Name="buckets" Expression="kBuckets" />
        <Intrinsic Name="numDataPerSlab" Expression="512" /> <!-- from kNumDataPerSlab -->
        <DisplayString>{{ ThreadLocalHandleDatabase }}</DisplayString>
        <Expand>
            <CustomListItems MaxItemsPerView="100">
                <Variable Name="Iter" InitialValue="0"/>
                <Variable Name="Max" InitialValue="1"/>
                ...
                <Variable Name="Slab" InitialValue="(Slab*)0"/>
                <Variable Name="HD" InitialValue="(HandleData*)0"/>
                <Loop Condition="Iter &lt; buckets()">
                    <Break Condition="!at(Iter)"/>
                    <Exec>Inner = 0</Exec>
                    <Loop>
                        <Break Condition="Inner &gt;= Max"/>
                        <Exec>Slab = (at(Iter)[Inner])</Exec>
                        <If Condition="Slab != nullptr">
                            <Exec>Index = 0</Exec>
                            <Loop Condition="Index &lt; numDataPerSlab()">
                                <Exec>HD = &amp;(Slab-&gt;data[Index])</Exec>
                                <If Condition="refs(HD) != 0">
                                    <Item Name="{(size_t)(lifecycle(HD) + (((Max - 1) + Inner) * numDataPerSlab()) + Index)}">*HD</Item>
                                </If>
                                <Exec>Index++</Exec>
                            </Loop>
                        </If>
    ...
    <!-- Same as carb::extras::HandleDatabase<*,*>::HandleData -->
    <Type Name="carb::tasking::ThreadLocalHandleDatabase&lt;*,*&gt;::HandleData">
        <Intrinsic Name="meta" Expression="*(uint64_t*)&amp;metadata" />
        <Intrinsic Name="refs" Expression="meta() &amp; 0xffffffff" />
        <DisplayString Condition="!!refs()">{{ {val} }}</DisplayString>
        <DisplayString>{{ free entry }}</DisplayString>
    ...
    <Type Name="carb::cpp::basic_string_view&lt;*,*&gt;">
    ...
    <Type Name="carb::cpp::basic_zstring_view&lt;*,*&gt;">
        <Intrinsic Name="size" Expression="m_count" />
        <Intrinsic Name="data" Expression="m_data" />
        <DisplayString>{m_data,[m_count]}</DisplayString>
        <Expand>
    ...
    Python code to generate block below, change n to increase maximum number of variants.
        ...
        print('\t<Type Name="carb::cpp::variant&lt;*&gt;">')
    ...
    <Type Name="omni::expected&lt;*,*&gt;">
        <DisplayString Condition="m_state == omni::detail::ExpectedState::eSUCCESS">[success] {m_storage.value}</DisplayString>
        <DisplayString Condition="m_state != omni::detail::ExpectedState::eSUCCESS">[failure] {m_storage.error}</DisplayString>
        <Expand>
            <Item Name="[success]" Condition="m_state == omni::detail::ExpectedState::eSUCCESS">m_storage.value</Item>
            <Item Name="[failure]" Condition="m_state != omni::detail::ExpectedState::eSUCCESS">m_storage.error</Item>
        </Expand>
    </Type>
    
    <Type Name="omni::string">
        <Intrinsic Name="isShortString" Expression="m_local_data.m_data[31] &lt;= 31" />
        <Intrinsic Name="allocatedData" Expression="*((allocated_data*)&amp;m_local_data)" />
        <Intrinsic Name="size" Expression="isShortString() ? (31 - m_local_data.m_data[31]) : allocatedData().m_size" />
        <Intrinsic Name="capacity" Expression="isShortString() ? 31 : allocatedData().m_capacity" />
        <Intrinsic Name="data" Expression="isShortString() ? m_local_data.m_data : allocatedData().m_ptr" />
    ...
    <Type Name="omni::vector&lt;*&gt;">
        <DisplayString>{{ size={m_last - m_first} }}</DisplayString>
        <Expand>
            <Item Name="[size]" ExcludeView="simple">m_last - m_first</Item>
            <Item Name="[capacity]" ExcludeView="simple">m_end - m_first</Item>
            <ArrayItems>
