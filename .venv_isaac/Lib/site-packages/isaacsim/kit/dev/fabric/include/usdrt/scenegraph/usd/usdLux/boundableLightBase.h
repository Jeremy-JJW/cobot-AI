...
inline const TfToken UsdLuxBoundableLightBase::_GetStaticTfType()
{
    const static TfToken token("UsdLuxBoundableLightBase");
    return token;
}

/* virtual */
inline const TfToken UsdLuxBoundableLightBase::_GetTfTypeToken() const
{
    const static TfToken token("UsdLuxBoundableLightBase");
    return token;
}
