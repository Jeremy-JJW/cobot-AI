...
public:
    ...
    static UsdGeomCylinder Define(const UsdStageRefPtr& stage, const SdfPath& path);
...
inline const TfToken UsdGeomCylinder::_GetStaticTfType()
{
    const static TfToken token("UsdGeomCylinder");
    return token;
}

/* virtual */
inline const TfToken UsdGeomCylinder::_GetTfTypeToken() const
{
    const static TfToken token("UsdGeomCylinder");
    return token;
}
...
/* static */
inline UsdGeomCylinder UsdGeomCylinder::Define(const UsdStageRefPtr& stage, const SdfPath& path)
{
    if (!stage)
    {
        // TODO error
    ...
    return UsdGeomCylinder(stage->DefinePrim(path, _GetStaticTfType()));
}


inline UsdAttribute UsdGeomCylinder::GetHeightAttr() const
{

    return GetPrim().GetAttribute(TfToken(UsdGeomTokens->height));
}

inline UsdAttribute UsdGeomCylinder::CreateHeightAttr() const
{
    return GetPrim().CreateAttribute(TfToken(UsdGeomTokens->height), SdfValueTypeNames->Double,
                                     /* custom = */ false);
}

inline UsdAttribute UsdGeomCylinder::GetRadiusAttr() const
{

    return GetPrim().GetAttribute(TfToken(UsdGeomTokens->radius));
}

inline UsdAttribute UsdGeomCylinder::CreateRadiusAttr() const
{
    return GetPrim().CreateAttribute(TfToken(UsdGeomTokens->radius), SdfValueTypeNames->Double,
                                     /* custom = */ false);
}

inline UsdAttribute UsdGeomCylinder::GetAxisAttr() const
{

    return GetPrim().GetAttribute(TfToken(UsdGeomTokens->axis));
}

inline UsdAttribute UsdGeomCylinder::CreateAxisAttr() const
{
    return GetPrim().CreateAttribute(TfToken(UsdGeomTokens->axis), SdfValueTypeNames->Token,
                                     /* custom = */ false);
}

inline UsdAttribute UsdGeomCylinder::GetExtentAttr() const
{

    return GetPrim().GetAttribute(TfToken(UsdGeomTokens->extent));
}

inline UsdAttribute UsdGeomCylinder::CreateExtentAttr() const
{
