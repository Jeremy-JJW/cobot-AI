...
#include "usdrt/scenegraph/usd/usdSkel/animation.h"
...
public:
    ...
    static UsdSkelPackedJointAnimation Define(const UsdStageRefPtr& stage, const SdfPath& path);
...
inline const TfToken UsdSkelPackedJointAnimation::_GetStaticTfType()
{
    const static TfToken token("UsdSkelPackedJointAnimation");
    return token;
}

/* virtual */
inline const TfToken UsdSkelPackedJointAnimation::_GetTfTypeToken() const
{
    const static TfToken token("UsdSkelPackedJointAnimation");
    return token;
}
...
/* static */
inline UsdSkelPackedJointAnimation UsdSkelPackedJointAnimation::Define(const UsdStageRefPtr& stage, const SdfPath& path)
{
    if (!stage)
    {
        // TODO error
    ...
    return UsdSkelPackedJointAnimation(stage->DefinePrim(path, _GetStaticTfType()));
}
