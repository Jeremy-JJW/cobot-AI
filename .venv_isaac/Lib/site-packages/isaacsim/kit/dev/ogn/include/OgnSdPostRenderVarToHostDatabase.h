...
public:
    static void initializeType(const NodeTypeObj& nodeTypeObj)
    {
        ...
        inputs::exec.initialize(*iNodeType, nodeTypeObj);
        inputs::gpu.initialize(*iNodeType, nodeTypeObj);
        inputs::renderVar.initialize(*iNodeType, nodeTypeObj);
        inputs::renderVarHostSuffix.initialize(*iNodeType, nodeTypeObj);
        inputs::rp.initialize(*iNodeType, nodeTypeObj);

        outputs::exec.initialize(*iNodeType, nodeTypeObj);
        outputs::renderVar.initialize(*iNodeType, nodeTypeObj);
...
std::tuple<int, int, int> OgnSdPostRenderVarToHostDatabase::sm_generatorVersionOgnSdPostRenderVarToHost{std::make_tuple(1,81,0)};
std::tuple<int, int, int> OgnSdPostRenderVarToHostDatabase::sm_targetVersionOgnSdPostRenderVarToHost{std::make_tuple(3,1,2)};
}
