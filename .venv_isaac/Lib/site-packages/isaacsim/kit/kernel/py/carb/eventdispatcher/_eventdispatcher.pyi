...
class Event():
    ...
    def consume(self) -> None: 
        """
        Consumes the event, preventing additional observers from being called.

        Raises:
            RuntimeError if the event is not currently being dispatched.
        """
    ...
    def is_consumed(self) -> bool:
        ...
        Returns:
            True if the event has been consumed via consume(), False otherwise.
...
class Observer():
    ...
    def enabled(self, arg1: bool) -> None:
        ...
        """
    @property
    def ignore_consume(self) -> bool:
        """
        Sets or gets the ignore-consume state of an observer.

        :type: bool
        """
    @ignore_consume.setter
    def ignore_consume(self, arg1: bool) -> None:
        """
        Sets or gets the ignore-consume state of an observer.
        """
    @property
