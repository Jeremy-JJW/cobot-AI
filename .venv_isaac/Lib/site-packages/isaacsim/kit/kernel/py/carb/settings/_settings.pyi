...
class ChangeEventType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    CHANGED: carb.settings._settings.ChangeEventType # value = <ChangeEventType.CHANGED: 1>
    CREATED: carb.settings._settings.ChangeEventType # value = <ChangeEventType.CREATED: 0>
    DESTROYED: carb.settings._settings.ChangeEventType # value = <ChangeEventType.DESTROYED: 2>
    __members__: dict # value = {'CREATED': <ChangeEventType.CREATED: 0>, 'CHANGED': <ChangeEventType.CHANGED: 1>, 'DESTROYED': <ChangeEventType.DESTROYED: 2>}
    pass
class ISettings():
    """
    ...
    def set_bool(self, arg0: str, arg1: bool) -> None: 
        ...
        """
    def set_bool_array(self, arg0: str, arg1: typing.List[bool]) -> None: 
        """
        ...
        """
    def set_default(self, path: str, value: object) -> None: ...
    ...
    def set_float(self, arg0: str, arg1: float) -> None: 
        ...
        """
    def set_float_array(self, arg0: str, arg1: typing.List[float]) -> None: 
        """
        Sets the given array at the supplied path.
    ...
    def set_int(self, arg0: str, arg1: int) -> None: 
        ...
        """
    def set_int_array(self, arg0: str, arg1: typing.List[int]) -> None: 
        """
        Sets the given array at the supplied path.
    ...
    def set_string(self, arg0: str, arg1: str) -> None: 
        ...
        """
    def set_string_array(self, arg0: str, arg1: typing.List[str]) -> None: 
        """
        Sets the given array at the supplied path.
    ...
    def unsubscribe_to_change_events(self, id: SubscriptionId) -> None: 
        ...
        """
    def update(self, arg0: str, arg1: carb.dictionary._dictionary.Item, arg2: str, arg3: object) -> None: 
        """
