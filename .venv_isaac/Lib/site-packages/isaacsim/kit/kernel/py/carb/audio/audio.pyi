...
class AudioResult():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    DEVICE_DISCONNECTED: carb.audio.audio.AudioResult # value = <AudioResult.DEVICE_DISCONNECTED: 1>
    DEVICE_LOST: carb.audio.audio.AudioResult # value = <AudioResult.DEVICE_LOST: 2>
    DEVICE_NOT_OPEN: carb.audio.audio.AudioResult # value = <AudioResult.DEVICE_NOT_OPEN: 3>
    DEVICE_OPEN: carb.audio.audio.AudioResult # value = <AudioResult.DEVICE_OPEN: 4>
    INVALID_FORMAT: carb.audio.audio.AudioResult # value = <AudioResult.INVALID_FORMAT: 12>
    INVALID_PARAMETER: carb.audio.audio.AudioResult # value = <AudioResult.INVALID_PARAMETER: 8>
    IO_ERROR: carb.audio.audio.AudioResult # value = <AudioResult.IO_ERROR: 11>
    NOT_ALLOWED: carb.audio.audio.AudioResult # value = <AudioResult.NOT_ALLOWED: 9>
    NOT_FOUND: carb.audio.audio.AudioResult # value = <AudioResult.NOT_FOUND: 10>
    NOT_SUPPORTED: carb.audio.audio.AudioResult # value = <AudioResult.NOT_SUPPORTED: 14>
    OK: carb.audio.audio.AudioResult # value = <AudioResult.OK: 0>
    OUT_OF_MEMORY: carb.audio.audio.AudioResult # value = <AudioResult.OUT_OF_MEMORY: 7>
    OUT_OF_RANGE: carb.audio.audio.AudioResult # value = <AudioResult.OUT_OF_RANGE: 5>
    TRY_AGAIN: carb.audio.audio.AudioResult # value = <AudioResult.TRY_AGAIN: 6>
...
class RolloffType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    INVERSE: carb.audio.audio.RolloffType # value = <RolloffType.INVERSE: 0>
    LINEAR: carb.audio.audio.RolloffType # value = <RolloffType.LINEAR: 1>
    LINEAR_SQUARE: carb.audio.audio.RolloffType # value = <RolloffType.LINEAR_SQUARE: 2>
...
class SampleFormat():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    COUNT: carb.audio.audio.SampleFormat # value = <SampleFormat.COUNT: 12>
    DEFAULT: carb.audio.audio.SampleFormat # value = <SampleFormat.DEFAULT: 11>
    FLAC: carb.audio.audio.SampleFormat # value = <SampleFormat.FLAC: 7>
    MP3: carb.audio.audio.SampleFormat # value = <SampleFormat.MP3: 9>
    OPUS: carb.audio.audio.SampleFormat # value = <SampleFormat.OPUS: 8>
    PCM16: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM16: 1>
    PCM24: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM24: 2>
    PCM32: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM32: 3>
    PCM8: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM8: 0>
    PCM_COUNT: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM_COUNT: 5>
    PCM_FLOAT: carb.audio.audio.SampleFormat # value = <SampleFormat.PCM_FLOAT: 4>
    RAW: carb.audio.audio.SampleFormat # value = <SampleFormat.RAW: 10>
    VORBIS: carb.audio.audio.SampleFormat # value = <SampleFormat.VORBIS: 6>
...
class Speaker():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BACK_CENTER: carb.audio.audio.Speaker # value = <Speaker.BACK_CENTER: 6>
    BACK_LEFT: carb.audio.audio.Speaker # value = <Speaker.BACK_LEFT: 4>
    BACK_RIGHT: carb.audio.audio.Speaker # value = <Speaker.BACK_RIGHT: 5>
    COUNT: carb.audio.audio.Speaker # value = <Speaker.COUNT: 17>
    FRONT_CENTER: carb.audio.audio.Speaker # value = <Speaker.FRONT_CENTER: 2>
    FRONT_LEFT: carb.audio.audio.Speaker # value = <Speaker.FRONT_LEFT: 0>
    FRONT_LEFT_WIDE: carb.audio.audio.Speaker # value = <Speaker.FRONT_LEFT_WIDE: 13>
    FRONT_RIGHT: carb.audio.audio.Speaker # value = <Speaker.FRONT_RIGHT: 1>
    FRONT_RIGHT_WIDE: carb.audio.audio.Speaker # value = <Speaker.FRONT_RIGHT_WIDE: 14>
    LOW_FREQUENCY_EFFECT: carb.audio.audio.Speaker # value = <Speaker.LOW_FREQUENCY_EFFECT: 3>
    SIDE_LEFT: carb.audio.audio.Speaker # value = <Speaker.SIDE_LEFT: 7>
    SIDE_RIGHT: carb.audio.audio.Speaker # value = <Speaker.SIDE_RIGHT: 8>
    TOP_BACK_LEFT: carb.audio.audio.Speaker # value = <Speaker.TOP_BACK_LEFT: 11>
    TOP_BACK_RIGHT: carb.audio.audio.Speaker # value = <Speaker.TOP_BACK_RIGHT: 12>
    TOP_FRONT_LEFT: carb.audio.audio.Speaker # value = <Speaker.TOP_FRONT_LEFT: 9>
    TOP_FRONT_RIGHT: carb.audio.audio.Speaker # value = <Speaker.TOP_FRONT_RIGHT: 10>
    TOP_LEFT: carb.audio.audio.Speaker # value = <Speaker.TOP_LEFT: 15>
    TOP_RIGHT: carb.audio.audio.Speaker # value = <Speaker.TOP_RIGHT: 16>
...
class UnitType():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    BYTES: carb.audio.audio.UnitType # value = <UnitType.BYTES: 0>
    FRAMES: carb.audio.audio.UnitType # value = <UnitType.FRAMES: 1>
    MICROSECONDS: carb.audio.audio.UnitType # value = <UnitType.MICROSECONDS: 3>
    MILLISECONDS: carb.audio.audio.UnitType # value = <UnitType.MILLISECONDS: 2>
