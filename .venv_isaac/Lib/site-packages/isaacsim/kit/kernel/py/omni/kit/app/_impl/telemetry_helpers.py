...
"""Helpers for emitting telemetry events from omni.kit.app.

Wraps discovery/enablement of the telemetry extension and offers a single
`send_telemetry_event` entry point that becomes a no-op when telemetry is
unavailable.
"""
...
def _initialize_telemetry():
    """Subscribes to telemetry extension enable/disable and caches its module.

    This is called lazily on first send and keeps a lightweight cached handle
    so subsequent sends only check a single variable.
    """
