...
- class IApp
  ...
  - def get_app_instance_id(self) -> str
  - def get_app_name(self) -> str
  - def get_app_session_id(self) -> str
...
- def queue_event(event_name: str, payload: object = None, **kwargs)
...
- GLOBAL_EVENT_ERROR_LOG: str
- GLOBAL_EVENT_ERROR_LOG_IMMEDIATE: str
- GLOBAL_EVENT_SCRIPT_COMMAND: str
- GLOBAL_EVENT_SCRIPT_COMMAND_IMMEDIATE: str
- GLOBAL_EVENT_SCRIPT_STDOUT: str
- GLOBAL_EVENT_SCRIPT_STDOUT_IMMEDIATE: str
- GLOBAL_EVENT_SCRIPT_STDERR: str
- GLOBAL_EVENT_SCRIPT_STDERR_IMMEDIATE: str
...
- EVENT_APP_READY: int
- GLOBAL_EVENT_APP_STARTED: str
- GLOBAL_EVENT_APP_READY: str
- GLOBAL_EVENT_POST_QUIT: str
- GLOBAL_EVENT_PRE_SHUTDOWN: str
- GLOBAL_EVENT_PRE_UPDATE: str
- GLOBAL_EVENT_UPDATE: str
- GLOBAL_EVENT_POST_UPDATE: str
- GLOBAL_MESSAGE_BUS: str
...
- def get_extension_name_and_version(ext_id) -> Tuple[str, str]
- def get_extension_name_tag_version(ext_id) -> Tuple[str, str, str]
...
- GLOBAL_EVENT_SCRIPT_CHANGED: str
- GLOBAL_EVENT_SCRIPT_CHANGED_IMMEDIATE: str
- GLOBAL_EVENT_FOLDER_CHANGED: str
- GLOBAL_EVENT_FOLDER_CHANGED_IMMEDIATE: str
- GLOBAL_EVENT_REGISTRY_REFRESH_BEGIN: str
- GLOBAL_EVENT_REGISTRY_REFRESH_BEGIN_DEFERRED: str
- GLOBAL_EVENT_REGISTRY_REFRESH_END: str
- GLOBAL_EVENT_REGISTRY_REFRESH_END_SUCCESS: str
- GLOBAL_EVENT_REGISTRY_REFRESH_END_SUCCESS_IMMEDIATE: str
- GLOBAL_EVENT_REGISTRY_REFRESH_END_FAILURE: str
- GLOBAL_EVENT_REGISTRY_REFRESH_END_FAILURE_IMMEDIATE: str
- GLOBAL_EVENT_EXTENSION_PULL_BEGIN: str
- GLOBAL_EVENT_EXTENSION_PULL_BEGIN_DEFERRED: str
- GLOBAL_EVENT_EXTENSION_PULL_END: str
- GLOBAL_EVENT_EXTENSION_PULL_END_SUCCESS: str
- GLOBAL_EVENT_EXTENSION_PULL_END_SUCCESS_IMMEDIATE: str
- GLOBAL_EVENT_EXTENSION_PULL_END_FAILURE: str
- GLOBAL_EVENT_EXTENSION_PULL_END_FAILURE_IMMEDIATE: str
...
- class UpdateAction
  ...
  - KEEP_SUBTREE: carb.dictionary._dictionary.UpdateAction
  - OVERWRITE: carb.dictionary._dictionary.UpdateAction
  - REPLACE_SUBTREE: carb.dictionary._dictionary.UpdateAction
...
- def get_yaml_serializer() -> ISerializer
...
- class ITokens
  ...
  - def resolve(self, str: str, flags: int = 0) -> object
...
- class AdapterType
  ...
  - FULL_ALIAS: carb.events._events.AdapterType
  - PUSH_PUMP: carb.events._events.AdapterType

- class IEvent
  - def consume(self)
  - [property] def is_consumed(self) -> bool
  - [property] def payload(self) -> carb.dictionary._dictionary.Item
  - [property] def sender(self) -> int
  - [property] def type(self) -> int

- class IEventStream
  - def create_subscription_to_pop(self, fn: typing.Callable[[IEvent], None], order: int = 0, name: str = '') -> ISubscription
  - def create_subscription_to_pop_by_type(self, event_type: int, fn: typing.Callable[[IEvent], None], order: int = 0, name: str = '') -> ISubscription
  - def create_subscription_to_push(self, fn: typing.Callable[[IEvent], None], order: int = 0, name: str = '') -> ISubscription
  - def create_subscription_to_push_by_type(self, event_type: int, fn: typing.Callable[[IEvent], None], order: int = 0, name: str = '') -> ISubscription
...
- class MappingEntry2(MappingEntry)
  - def __init__(self, type: int, dispatch_name: str, push_name: str = '', filters: object = None)
  - [property] def filters(self) -> object
  - [filters.setter] def filters(self, arg1: object)
...
- def get_events_adapter_interface() -> IEventsAdapter
...
- class Result
  ...
  - END_OF_FILE: omni.core._core.Result
  ...
  - NOT_DIRECTORY: omni.core._core.Result
...
- class AudioResult
  ...
  - [property] def name(self) -> str
  - [property] def value(self) -> int
  - DEVICE_DISCONNECTED: carb.audio.audio.AudioResult
  - DEVICE_LOST: carb.audio.audio.AudioResult
  - DEVICE_NOT_OPEN: carb.audio.audio.AudioResult
  - DEVICE_OPEN: carb.audio.audio.AudioResult
  - INVALID_FORMAT: carb.audio.audio.AudioResult
  - INVALID_PARAMETER: carb.audio.audio.AudioResult
  - IO_ERROR: carb.audio.audio.AudioResult
  - NOT_ALLOWED: carb.audio.audio.AudioResult
  - NOT_FOUND: carb.audio.audio.AudioResult
  - NOT_SUPPORTED: carb.audio.audio.AudioResult
  - OK: carb.audio.audio.AudioResult
  - OUT_OF_MEMORY: carb.audio.audio.AudioResult
  - OUT_OF_RANGE: carb.audio.audio.AudioResult
  - TRY_AGAIN: carb.audio.audio.AudioResult
...
- class RolloffType
  ...
  - [property] def name(self) -> str
  - [property] def value(self) -> int
  - INVERSE: carb.audio.audio.RolloffType
  - LINEAR: carb.audio.audio.RolloffType
  - LINEAR_SQUARE: carb.audio.audio.RolloffType

- class SampleFormat
  - def __init__(self, value: int)
  - [property] def name(self) -> str
  - [property] def value(self) -> int
  - COUNT: carb.audio.audio.SampleFormat
  - DEFAULT: carb.audio.audio.SampleFormat
  - FLAC: carb.audio.audio.SampleFormat
  - MP3: carb.audio.audio.SampleFormat
  - OPUS: carb.audio.audio.SampleFormat
  - PCM16: carb.audio.audio.SampleFormat
  - PCM24: carb.audio.audio.SampleFormat
  - PCM32: carb.audio.audio.SampleFormat
  - PCM8: carb.audio.audio.SampleFormat
  - PCM_COUNT: carb.audio.audio.SampleFormat
  - PCM_FLOAT: carb.audio.audio.SampleFormat
  - RAW: carb.audio.audio.SampleFormat
  - VORBIS: carb.audio.audio.SampleFormat
...
- class Speaker
  ...
  - [property] def name(self) -> str
  - [property] def value(self) -> int
  - BACK_CENTER: carb.audio.audio.Speaker
  - BACK_LEFT: carb.audio.audio.Speaker
  - BACK_RIGHT: carb.audio.audio.Speaker
  - COUNT: carb.audio.audio.Speaker
  - FRONT_CENTER: carb.audio.audio.Speaker
  - FRONT_LEFT: carb.audio.audio.Speaker
  - FRONT_LEFT_WIDE: carb.audio.audio.Speaker
  - FRONT_RIGHT: carb.audio.audio.Speaker
  - FRONT_RIGHT_WIDE: carb.audio.audio.Speaker
  - LOW_FREQUENCY_EFFECT: carb.audio.audio.Speaker
  - SIDE_LEFT: carb.audio.audio.Speaker
  - SIDE_RIGHT: carb.audio.audio.Speaker
  - TOP_BACK_LEFT: carb.audio.audio.Speaker
  - TOP_BACK_RIGHT: carb.audio.audio.Speaker
  - TOP_FRONT_LEFT: carb.audio.audio.Speaker
  - TOP_FRONT_RIGHT: carb.audio.audio.Speaker
  - TOP_LEFT: carb.audio.audio.Speaker
  - TOP_RIGHT: carb.audio.audio.Speaker

- class UnitType
  - def __init__(self, value: int)
  - [property] def name(self) -> str
  - [property] def value(self) -> int
  - BYTES: carb.audio.audio.UnitType
  - FRAMES: carb.audio.audio.UnitType
  - MICROSECONDS: carb.audio.audio.UnitType
  - MILLISECONDS: carb.audio.audio.UnitType
...
- class Event
  ...
  - [property] def is_consumed(self) -> bool
  - [property] def payload(self) -> dict
...
- class IEventDispatcher
  ...
  - def get_observers(self, event_names: typing.List[str], filter: handle = None) -> typing.List[Observer]
...
- class Observer
  - [property] def enabled(self) -> bool
  - [enabled.setter] def enabled(self, arg1: bool)
  - [property] def ignore_consume(self) -> bool
  - [ignore_consume.setter] def ignore_consume(self, arg1: bool)
  - [property] def name(self) -> str
  - [property] def order(self) -> int
  - [order.setter] def order(self, arg1: int)
...
- class IStructuredLogSettings3(_IStructuredLogSettings3, omni.core._core.IObject)
  - def __init__(self, arg0: omni.core._core.IObject)
  - def __init__(self)
  - def settings_load_complete(self)
  - [property] def message_source_tag(self)
  - [message_source_tag.setter] def message_source_tag(*args, **kwargs)
