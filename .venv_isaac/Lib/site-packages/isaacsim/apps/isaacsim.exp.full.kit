...
"omni.behavior.scripting.bundle" = {}
"omni.behavior.tree.bundle" = {}
...
"omni.usd.metrics.assembler.usdgeom" = {}
"omni.usd.schema.scene.visualization" = {}
"omni.kit.converter.cad" = {order = 200, version = "~209.4"}
...
# keep Test Runner populated with Isaac tests even if dependency extensions set narrower filters
...
vulkan = true                          # Explicitly enable Vulkan
enableDeveloperWarnings = false        # Disable developer warnings to reduce log noise
runLoops.main.rateLimitEnabled = true  # Enable main run-loop rate limit (loop sleeps at end of frame to cap tick rate); paired with rateLimitFrequency (default 60 hz)
runLoops.main.manualModeEnabled = true # Enable manual mode, dt is fixed at requested rate
player.useFixedTimeStepping = true     # Enable fixed time stepping; timeline forces dt = 1/timeCodesPerSecond regardless of measured wall-clock dt
